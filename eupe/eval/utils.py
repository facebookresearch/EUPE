...
import numpy as np
import torch
from eupe.data import DatasetWithEnumeratedTargets, make_data_loader, SamplerType
from eupe.eval.accumulators import NoOpAccumulator, ResultsAccumulator
...
class ModelWithIntermediateLayers(nn.Module):
    def __init__(
        self, feature_model, n, autocast_ctx, reshape=False, return_class_token=True
    ):
        super().__init__()
