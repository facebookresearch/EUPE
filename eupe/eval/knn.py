...
from eupe.data import SamplerType, make_data_loader, make_dataset
from eupe.data.adapters import DatasetWithEnumeratedTargets
from eupe.data.transforms import (
    CROP_DEFAULT_SIZE,
    RESIZE_DEFAULT_SIZE,
    get_target_transform,
    make_classification_eval_transform,
)
from eupe.distributed import gather_all_tensors
from eupe.eval.data import (
...
from eupe.eval.metrics import ClassificationMetricType, build_classification_metric
from eupe.eval.setup import ModelConfig, load_model_and_context
from eupe.eval.utils import ModelWithNormalize, average_metrics, evaluate
from eupe.eval.utils import save_results as default_save_results_func
