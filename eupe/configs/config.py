...
from eupe.logging import cleanup_logging, setup_logging
from eupe.utils import fix_random_seeds, get_conda_env, get_sha
...
def get_cfg_from_args(args: EupeSetupArgs, multidistillation=False, strict=True):
    overrides = [*args.opts]
...
def setup_config(args: EupeSetupArgs, strict_cfg=True):
    """
...
def setup_multidistillation(args: EupeSetupArgs):
